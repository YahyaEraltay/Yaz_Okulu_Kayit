<%@ Page Title="" Language="C#" MasterPageFile="~/sablon.Master" AutoEventWireup="true" CodeBehind="OgrGüncelle.aspx.cs" Inherits="Yaz_Okulu_Kayıt.OgrGüncelle" %>
    ...
    <form id="Form1" runat="server">
        <div>
            <div class="form-group">
                <div>
                    <strong>
                        <asp:Label for="TextBox7" runat="server" Text="Öğrenci ID"></asp:Label></strong>
            ...
            <div class="ortalama">
                <asp:Button ID="Button1" runat="server" Text="Kaydet" Height="75px"  Width="164px" CssClass="btn btn-warning" Font-Size="Large" Style="font-weight: bold;" OnClick="Button1_Click"  />
            </div>
        </div>
    </form>
</asp:Content>
